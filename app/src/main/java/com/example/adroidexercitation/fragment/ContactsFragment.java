...
import com.example.adroidexercitation.ContactAdapter;
import com.example.adroidexercitation.LetterView;
...
public class ContactsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final ContactAdapter adapter = new ContactAdapter(getContext(), contactNames);
